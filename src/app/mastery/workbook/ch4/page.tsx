...
export default function Chapter4() {
  ...
  const handleContinue = async () => {
    const ch4Data = { ruleStatement, ruleFear, bodyMoment, bodyAware, newResponse, newRule, practiceScenario, letterToSelf, finalReflection };
    await saveProgress('ch4', ch4Data);
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white px-6 py-10 max-w-2xl mx-auto">
      ...
      <p className="text-slate-400 mb-8 leading-relaxed">
        You have seen what you tolerate. You have seen how you respond. You have walked through your first house. Now something very important begins. We bring it all together â and then we begin to change it.
      </p>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-5">
          <div>
            <label className="text-amber-400 text-xs font-bold tracking-widest uppercase block mb-2">"In order to be safe, loved, or acceptedâ¦ I mustâ¦"</label>
            <textarea
              value={ruleStatement}
        ...
        <div className="bg-slate-800/60 rounded-2xl p-5 mt-6 border border-amber-400/20">
          <p className="text-slate-300 text-sm leading-relaxed">
            This rule is not who you are. It is something you learned. A child created it. A child needed it. That child deserves compassion. But now you are an adult â and you have awareness. And awareness gives you choice.
          </p>
        </div>
      </div>
      ...
      <div className="border-t border-slate-700 pt-8 mb-8">
        ...
        <p className="text-slate-400 mb-6">Think of a recent moment when you felt triggered. Not a big moment â just something real.</p>
        ...
        <div className="mt-6 space-y-4">
          ...
          <div>
            <label className="text-amber-400 text-xs font-bold tracking-widest uppercase block mb-2">"Is this happening right now â or is this from my past?"</label>
      ...
      <div className="border-t border-slate-700 pt-8 mb-8">
        ...
        <p className="text-slate-400 mb-4">You cannot just replace it with positive thinking. Your new rule must come from truth â from who you are now, from what is actually possible in your life today.</p>
        <div className="bg-slate-800/40 rounded-xl p-4 border border-slate-700/30 mb-6">
          <p className="text-slate-300 text-sm italic">Example â Old rule: "If I speak up, I will be rejected." New rule: "I can speak up and still be accepted by the right people." The new rule does not deny the fear. It gives you a new experience.</p>
        </div>
        <label className="text-amber-400 text-xs font-bold tracking-widest uppercase block mb-2">My new rule â "It is now safe for me toâ¦ / I am allowed toâ¦ / I can ________ and still be okay."</label>
        <textarea
          value={newRule}
          onChange={e => setNewRule(e.target.value)}
          placeholder="Write something real, not forced. It may feel unfamiliar â that is okay."
          rows={3}
          className="w-full bg-slate-800 border border-slate-600 rounded-xl px-4 py-3 text-white placeholder-slate-500 resize-none focus:outline-none focus:border-amber-400 transition-colors"
        />
      </div>
      ...
      <div className="border-t border-slate-700 pt-8 mb-8">
        ...
        <p className="text-slate-400 mb-4 text-sm italic">Begin with "My dearâ¦" â You might say: "I see now what I have been doingâ¦" or "I forgive myself forâ¦" or "I am ready toâ¦"</p>
        <textarea
          value={letterToSelf}
      ...
      <div className="bg-slate-800/40 rounded-xl p-5 border border-amber-400/20 mb-8">
        <p className="text-slate-300 text-sm leading-relaxed italic">
          Change does not come from pressure. It comes from awareness and from staying present. There will be moments when you forget. When that happens â do not judge yourself. Just notice. And choose again. You are not broken. You are not too late. You were living by a rule. And now you are free to write a new one.
        </p>
        <p className="text-amber-400 text-sm font-semibold mt-3">â Pamela</p>
      </div>
      ...
      >
        Continue to Chapter 5 â
      </button>
      <a href="/mastery/workbook/ch3" className="block text-center text-slate-500 text-sm mt-4 hover:text-slate-400">â Back to Chapter 3</a>
    </div>
  );
}