      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <Section title="Who processes your data">
          <ul className="space-y-2 list-disc pl-5">
            ...
            <li><strong className="text-slate-200">ElevenLabs</strong> — generates the podcast audio in Pamela&apos;s voice clone.</li>
            <li><strong className="text-slate-200">Creatomate</strong> — renders your personalized video.</li>
            ...
            <li><strong className="text-slate-200">Vercel</strong> — hosts the application and stores your session.</li>
          </ul>
        </Section>
